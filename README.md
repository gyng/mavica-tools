...
I built this tool since it's difficult to get a good working floppy disk in 2026 and want to make sure I don't lose photos to corruption from using bad disks. Then I bolted on a few convenience tools for EXIF (since EXIF wasn't common back then!)
